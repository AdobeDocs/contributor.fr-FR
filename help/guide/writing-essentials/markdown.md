...
Pour les liens vers des articles (références croisées) dans le référentiel, utilisez des liens relatifs. Vous pouvez utiliser tous les opérandes de lien relatif, tels que ./ (répertoire actuel), ../ (un répertoire précédent), et ../../ (deux répertoires précédents).
...
* [Principes de base de Markdown de GitHub](https://docs.github.com/fr/github/writing-on-github/getting-started-with-writing-and-formatting-on-github)
