...
Chaque fois que du contenu est traduit automatiquement, que ce soit par défaut ou à la demande de l’utilisateur, il est possible de faire parvenir à Adobe des commentaires sur les traductions. Dans le
Barre horizontale bleu clair en haut de la page, vous pouvez répondre « Oui » ou « Non » à la question « Cette traduction a-t-elle été utile ? ». Adobe collecte cette valeur
mesure et analyse les données compilées afin de prendre des décisions concernant la traduction de contenu. Nous apprécions vos commentaires et nous vous encourageons à répondre à cette question.

![Commentaires](assets/machine-translation-feedback.png)

À l’avenir, nous prévoyons de vous permettre de fournir des commentaires plus complets, sous la forme de la journalisation d’un problème, de la suggestion d’améliorations et même de la demande
autres langues. Certaines de ces fonctionnalités sont déjà disponibles sur les pages en anglais. À long terme, nous pensons que cela aidera Adobe à améliorer l’utilisateur
expérience sur ces pages.
